...
map_dfc(1:10, ~neo_axes_PCA$rotation[, .] * sqrt(neo_axes_PCA$sdev ^ 2)[.])
...
```{r pc1-pc2, fig.cap = "PCA: individuals and variables for PC1 and PC2"}

pc1 <- autoplot(neo_axes_PCA, x = 1, y = 2, variance_percentage = TRUE, label = FALSE, label.repel = TRUE, label.size = 2) + my_theme
