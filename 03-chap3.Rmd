...
pc1 <- autoplot(neo_axes_PCA, x = 1, y = 2, variance_percentage = TRUE, label = FALSE) + my_theme
...
```{r panel-clusters, fig.size=16, fig.fullwidth=TRUE, fig.cap="The 4 Momocs clusters colour coded onto a panel plot of axe outlines"}

panel(outlines, palette=col_spring, 
      fac=as.factor(kmeans4$cluster), names=as.factor(no_errors$axe_id), 
      cex.names=0.5, fromtop=TRUE)
```
