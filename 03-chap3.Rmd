...
kable(map_dfc(1:4, ~neo_axes_PCA$rotation[, .] * sqrt(neo_axes_PCA$sdev ^ 2)[.]), 
      row.names=TRUE, col.names = c("PC1", "PC2", "PC3", "PC4"), 
...
Finally, to get a feel for the appearance of a typical axe in each cluster, mean shapes were plotted (Figure \@ref(fig:meanshapes)). 

```{r meanshapes, fig.cap="Mean shapes for each of the 4 clusters"}
