...
\documentclass[12pt,msc,a4paper,twoside]{ucl_thesis}
...
\department{Institute of Arcaeology}
...
% \pagestyle{fancyplain} % turns page numbering back on
  ...
  \NormalTok{  devtools}\OperatorTok{::}\KeywordTok{install_github}\NormalTok{(}\StringTok{"benyohaiphysics/thesisdownUCL"}\NormalTok{)}
  \KeywordTok{library}\NormalTok{(thesisdownUCL)}
  \end{Highlighting}
  \end{Shaded}
